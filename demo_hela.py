...
if __name__ == "__main__":
    ...
    # pos mode
    pos_ms1_file = "example/data/Hela/pos-Hela-O3_quant_full.csv"
    pos_ms1_file_type = "mzmine"
    pos_ms2_file = "example/data/Hela/pos-Hela-O3.mgf"
    pos_ms2_file_type = "mgf"
    
    pos_ms1_out_file = "example/results/Hela/pos_Hela-ms1.csv"
    pos_features_all_out_file = "example/results/Hela/pos_Hela-ms1_all.csv"
    ...
    neg_ms1_file = "example/data/Hela/neg-Hela-O3_quant_full.csv"
    neg_ms1_file_type = "mzmine"
    neg_ms2_file = "example/data/Hela/neg-Hela-O3.mgf"
    neg_ms2_file_type = "mgf"
    
    neg_ms1_out_file = "example/results/Hela/neg_Hela-ms1.csv"
    neg_features_all_out_file = "example/results/Hela/neg_Hela-ms1_all.csv"
